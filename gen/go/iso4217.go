...
var (
	...
	AUD = &iso.Entity{
		...
		Entities:        []string{"AU", "CC", "CX", "HM", "KI", "NF", "NR", "TV"},
	...
	NZD = &iso.Entity{
		...
		Entities:        []string{"CK", "NU", "NZ", "PN", "TK"},
	...
	GBP = &iso.Entity{
		...
		Entities:        []string{"GG", "IM", "JE", "SH", "GB"},
	...
	USD = &iso.Entity{
		...
		Entities:        []string{"AS", "EC", "FM", "GU", "IO", "MH", "MP", "PA", "PR", "PW", "SV", "TC", "UM", "US", "VG"},
